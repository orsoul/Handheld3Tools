...
public class CrcCalculator {
    ...
    public static final byte[] TestBytes = new byte[]{49, 50, 51, 52, 53, 54, 55, 56, 59};
    ...
    public long Calc(byte[] data, int offset, int length) {
        long init =
            Parameters.RefOut ? CrcHelper.ReverseBits(Parameters.Init, HashSize) : Parameters.Init;
