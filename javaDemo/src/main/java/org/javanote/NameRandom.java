...
public class NameRandom {
  public static final String[] SURNAME = new String[]{
      ...
      "白", "怀", "蒲", "台", "从", "鄂", "索", "咸", "籍", "赖", "卓", "蔺", "屠", "蒙", "池", "乔", "阴", "欎", "胥",
      "能", "苍", "双", "闻", "莘", "党", "翟", "谭", "贡", "劳", "逄", "姬", "申", "扶", "堵", "冉", "宰", "郦", "雍",
      "郤", "璩", "桑", "桂", "濮", "牛", "寿", "通", "边", "扈", "燕", "冀", "郏", "浦", "尚", "农", "温", "别", "庄",
      "晏", "柴", "瞿", "阎", "充", "慕", "连", "茹", "习", "宦", "艾", "鱼", "容", "向", "古", "易", "慎", "戈", "廖",
      "庾", "终", "暨", "居", "衡", "步", "都", "耿", "满", "弘", "匡", "国", "文", "寇", "广", "禄", "阙", "东", "殴",
      "殳", "沃", "利", "蔚", "越", "夔", "隆", "师", "巩", "厍", "聂", "晁", "勾", "敖", "融", "冷", "訾", "辛", "阚",
      "那", "简", "饶", "空", "曾", "毋", "沙", "乜", "养", "鞠", "须", "丰", "巢", "关", "蒯", "相", "查", "后", "荆",
      "红", "游", "竺", "权", "逯", "盖", "益", "桓", "公", "万俟", "司马", "上官", "欧阳", "夏侯", "诸葛", "闻人", "东方",
      "赫连", "皇甫", "尉迟", "公羊", "澹台", "公冶", "宗政", "濮阳", "淳于", "单于", "太叔", "申屠", "公孙", "仲孙", "轩辕",
      "令狐", "钟离", "宇文", "长孙", "慕容", "鲜于", "闾丘", "司徒", "司空", "亓官", "司寇", "仉", "督", "子车", "颛孙", "端木",
      "巫马", "公西", "漆雕", "乐正", "壤驷", "公良", "拓跋", "夹谷", "宰父", "谷梁", "晋", "楚", "闫", "法", "汝", "鄢", "涂",
      "钦", "段干", "百里", "东郭", "南门", "呼延", "归海", "羊舌", "微生", "岳", "帅", "缑", "亢", "况", "郈", "有琴", "梁丘",
      "左丘", "东门", "西门", "商", "牟", "佘", "佴", "伯", "赏", "南宫", "墨", "哈", "谯", "笪", "年", "爱", "阳", "佟",
      "第五", "言", "福", "百", "姓"
  };
  public static final String[] MAN1 =
      new String[]{"梓", "子", "浩", "涵", "宇", "昊", "俊", "睿", "皓", "博"};
  public static final String[] MAN2 =
      new String[]{"轩", "宇", "泽", "豪", "宸", "睿", "航", "洋", "铭", "辰"};
  public static final String[] WOMEN1 =
      new String[]{"梓", "雨", "若", "诗", "思", "语", "欣", "艺", "可", "梦"};
  public static final String[] WOMEN2 =
      new String[]{"涵", "萱", "怡", "彤", "琪", "馨", "妍", "诺", "欣", "桐"};

  public static void main(String[] args) {
    Random random = new Random();
    boolean isMan = random.nextBoolean();
    String[] n1 = isMan ? MAN1 : WOMEN1;
    String[] n2 = isMan ? MAN2 : WOMEN2;

    //String format = String.format("%s%s%s",
    //    SURNAME[random.nextInt(SURNAME.length)],
    //    n1[random.nextInt(n1.length)],
    //    n2[random.nextInt(n2.length)]);
    Logs.out("%s:%s-%s%s", isMan ? "男" : "女",
        SURNAME[random.nextInt(SURNAME.length)],
        n1[random.nextInt(n1.length)],
        n2[random.nextInt(n2.length)]);
  }
