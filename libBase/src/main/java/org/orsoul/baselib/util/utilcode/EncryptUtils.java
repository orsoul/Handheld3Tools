...
public final class EncryptUtils {
    ...
    public static void main(String[] args) {
        String str = "123";
        System.out.println(bytes2HexString(encryptMD5(str.getBytes(), 1)));
        System.out.println(bytes2HexString(encryptMD5(str.getBytes(), 2)));
        System.out.println(bytes2HexString(encryptMD5(str.getBytes(), 3)));
    }
    ...
    public static byte[] encryptMD5(final byte[] data, int times) {
        return hashTemplate(data, "MD5", times);
    }
     ...
     * @return the bytes of hash encryption
     */
    private static byte[] hashTemplate(final byte[] data, final String algorithm, final int times) {
        ...
        try {
            ...
            for (int i = 1; i < times; i++) {
                digest = bytes2HexString(digest).getBytes();
     ...
     * @param iv             The buffer with the IV. The contents of the buffer are
