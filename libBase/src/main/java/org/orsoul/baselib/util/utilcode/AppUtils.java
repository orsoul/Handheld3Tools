package org.orsoul.baselib.util.utilcode;
...
public final class AppUtils {
    ...
    public static void installApp(final File file) {
        ...
        AppUtil.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        AppUtil.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AppUtil.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        ...
        try {
            PackageManager pm = AppUtil.getApp().getPackageManager();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(AppUtil.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return AppUtil.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        AppUtil.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = AppUtil.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(AppUtil.getApp().getPackageName());
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AppUtil.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return AppUtil.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(AppUtil.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AppUtil.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AppUtil.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AppUtil.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AppUtil.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(AppUtil.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(AppUtil.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(AppUtil.getApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(AppUtil.getApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            ApplicationInfo ai = AppUtil.getApp().getPackageManager().getApplicationInfo(pkgName, 0);
            if (ai != null) {
                return ai.uid;
            }
        } catch (Exception e) {
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(AppUtil.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(AppUtil.getApp(), authority, file);
            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        }
        AppUtil.getApp().grantUriPermission(AppUtil.getApp().getPackageName(), data, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = AppUtil.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AppUtil.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AppUtil.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AppUtil.getApp()
